...
- **Nested association JSON fields** (#86) — Nested forms now render `:json` child fields as pretty-printed textareas and recursively coerce nested `*_attributes` JSON strings back into structured values.
